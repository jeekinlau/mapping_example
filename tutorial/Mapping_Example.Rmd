...
changes in genotypic dosage calls that the HMM chain makes can be observed below

![changes in dosage](../figures/genotype_imputation_changes.jpeg){width="1500"}
...
polymapR also has some tools that mappoly does not have like `screen_for_duplicate_individuals()` and `PCA_progeny()`
