...
Okay now that we found some duplicates, lets remove them from the dataset and rerun everything from the top... it should not tak that long maybe max 10 min
