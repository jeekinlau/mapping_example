...
If you want to run the more experimental versions of the software
...
Here we will look for contaminants and duplicates and remove them from the analysis. Good idea because you have no idea what kind of errors you have in genotyping. We will use the functions the developers have implemented to help going between different software
...
fit_model calculates the variance components and estimates the
